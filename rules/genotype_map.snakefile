...
rule gt_map_primary_alignment:
    ...
    shell:
        ...
        """    done <{SAMPLE_REGIONS} | \n"""
        """    samtools view -S -t {SAMPLE_REF_FAI} -u -b - | \n"""
        """    samtools collate -n 32 -O - {PRIMARY_TEMP}/primary_bam | \n"""
        """    samtools bam2fq - | \n"""
        """    seqtk dropse -; \n"""
        """    samtools view {SAMPLE_BAM} '*' | \n"""
        """    samtools bam2fq - | \n"""
        """    python {SMRTSV_DIR}/scripts/genotype/FilterFastqHardmask.py --max_mask_prop=0.05 /dev/stdin | \n"""
        """    seqtk dropse -; \n"""
        """}} | """
